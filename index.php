...
<html lang="en">
	<head>
	    ...
	    <title>Trang Chủ Laptop Thịnh Vượng</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">30 Ngày đổi trả dễ dàng.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Miễn phí hip nội thành hà nội</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Giảm giá cho học sinh, sinh viên</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
